...
CREATE OR REPLACE FUNCTION "public"."rpc_rebuild_container_side_effects"("p_container_id" "uuid", "p_operator_id" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."rpc_rebuild_container_side_effects"("p_container_id" "uuid", "p_operator_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."container_event" (
    ...
    CONSTRAINT "container_event_event_type_check" CHECK (("event_type" = ANY (ARRAY['PURCHASE'::"text", 'YARD_ENTER'::"text", 'YARD_EXIT'::"text", 'TRANSFER_OUT'::"text", 'TRANSFER_IN'::"text", 'TRANSFER_CANCELLED'::"text", 'LEASE_ONHIRE'::"text", 'LEASE_OFFHIRE'::"text", 'SALE_CONTRACTED'::"text", 'SALE_DELIVERED'::"text", 'TOTAL_LOSS'::"text", 'REPAIR'::"text", 'SCRAP'::"text"])))
);
...
GRANT ALL ON FUNCTION "public"."rpc_rebuild_container_side_effects"("p_container_id" "uuid", "p_operator_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."rpc_rebuild_container_side_effects"("p_container_id" "uuid", "p_operator_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."rpc_rebuild_container_side_effects"("p_container_id" "uuid", "p_operator_id" "uuid") TO "service_role";
